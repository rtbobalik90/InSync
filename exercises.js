...
(function () {
  ...
  var LIST = [
    ...
    ['chest-fly-machine', 'Chest fly machine', 'Chest', 'Machine', 3, '10–12'],
    ...
    ['face-pull', 'Face pull', 'Back', 'Cable', 3, '12–15'],
    ...
    ['smith-shoulder-press', 'Smith shoulder press', 'Shoulders', 'Smith', 3, '8–10'],
    ['lateral-raise', 'Lateral raise', 'Shoulders', 'Dumbbell', 3, '12–15'],
    ['cable-lateral-raise', 'Cable lateral raise', 'Shoulders', 'Cable', 3, '12–15'],
    ['reverse-fly-machine', 'Reverse fly machine', 'Shoulders', 'Machine', 3, '12–15'],
    ...
    ['seated-leg-curl', 'Seated leg curl', 'Legs', 'Machine', 3, '10–12'],
    ...
    ['hip-abduction-machine', 'Hip abduction machine', 'Legs', 'Machine', 3, '12–15'],
    ['hip-adduction-machine', 'Hip adduction machine', 'Legs', 'Machine', 3, '12–15'],
    ['dumbbell-rdl', 'Dumbbell Romanian deadlift', 'Legs', 'Dumbbell', 3, '8–10'],
    ['squats', 'Squats', 'Legs', 'Bodyweight', 3, '12–15'],
    ['lunges', 'Lunges', 'Legs', 'Bodyweight', 3, '10 each'],
    ['step-ups', 'Step-ups', 'Legs', 'Bodyweight', 3, '10 each'],
    ['split-squat', 'Split squat', 'Legs', 'Bodyweight', 3, '8–10 each'],
    ...
    ['dead-bug', 'Dead bug', 'Core', 'Bodyweight', 3, '8 each'],
    ['pallof-press', 'Pallof press', 'Core', 'Cable', 3, '10 each'],
