...
(function(){
 ...
 ok(sw.includes("CACHE = 'insync-v10-27'"),'service-worker cache is bumped so the parked build replaces the previous Faith UI');
 ...
 ok(app.includes("version:'6.0.0-p5.5'")&&screens.includes('Version 6.0.0-p5.5'),'runtime and Settings identify the parked Phase 3 build');
