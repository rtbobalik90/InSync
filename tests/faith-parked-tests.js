...
(function(){
 ...
 ok(sw.includes("CACHE = 'insync-v10-35'"),'service-worker cache is bumped so the parked build replaces the previous Faith UI');
 ...
 ok(app.includes("version:'6.0.0-p6.2'")&&screens.includes('Version 6.0.0-p6.2'),'runtime and Settings identify the parked Phase 3 build');
