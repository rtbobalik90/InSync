...
(function(){
 ...
 ok(sw.includes("CACHE = 'insync-v10-21'"),'service-worker cache is bumped so the parked build replaces the previous Faith UI');
 ...
 ok(app.includes("version:'6.0.0-p4'")&&screens.includes('Version 6.0.0-p4'),'runtime and Settings identify the parked Phase 3 build');
