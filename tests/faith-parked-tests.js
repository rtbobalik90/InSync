...
(function(){
 ...
 ok(sw.includes("CACHE = 'insync-v10-31'"),'service-worker cache is bumped so the parked build replaces the previous Faith UI');
 ...
 ok(app.includes("version:'6.0.0-p5.7.2'")&&screens.includes('Version 6.0.0-p5.7.2'),'runtime and Settings identify the parked Phase 3 build');
