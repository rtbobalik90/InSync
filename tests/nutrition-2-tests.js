...
(async()=>{
 ...
 ok(index.includes('<script src="nutrition.js"></script>')&&sw.includes("'nutrition.js'")&&sw.includes("insync-v10-32"),'Nutrition 2.0 engine is in production and offline shell');
 ...
 ok(app.includes("version:'6.0.0-p5.8'")&&screens.includes('Version 6.0.0-p5.8'),'runtime and Settings identify Phase 5');
