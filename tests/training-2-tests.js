...
// Production wiring and the expanded media library.
{
 ...
 ok(sw.includes("'training.js'")&&sw.includes("CACHE = 'insync-v10-32'"),'Training engine is available offline under the Phase 4 cache');
...
// Cloud planner is equipment-aware and the UI exposes the full Phase 4 loop.
{
 ...
 ok(app.includes("version:'6.0.0-p5.8'")&&screens.includes('Version 6.0.0-p5.8'),'runtime and Settings identify Phase 4');
}
