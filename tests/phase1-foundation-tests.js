...
ok(sw.includes("CACHE = 'insync-v10-19'")&&sw.includes("'journeys.js'")&&sw.includes("'camp.js'"),'service-worker shell contains the complete Phase 1 foundation');
ok(app.includes("version:'6.0.0-p3b'")&&screensSource.includes('Version 6.0.0-p3b'),'runtime and Settings preserve the Phase 1 foundation in the Phase 2 build');
