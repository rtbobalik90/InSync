...
(async function(){
 ...
 ok(sw.includes("CACHE = 'insync-v10-19'")&&sw.includes("'intelligence.js'")&&sw.includes("'prompt-registry.js'"),'Phase 2 Intelligence files are part of the offline shell');
 ok(app.includes("version:'6.0.0-p3b'")&&settings.includes('Version 6.0.0-p3b'),'runtime and Settings identify the Phase 2 build');
