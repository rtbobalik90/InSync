...
(async function(){
 ...
 ok(sw.includes("CACHE = 'insync-v10-31'")&&sw.includes("'intelligence.js'")&&sw.includes("'prompt-registry.js'"),'Phase 2 Intelligence files are part of the offline shell');
 ok(app.includes("version:'6.0.0-p5.7.2'")&&settings.includes('Version 6.0.0-p5.7.2'),'runtime and Settings identify the Phase 2 build');
