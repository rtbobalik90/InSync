...
(async function(){
 ...
 ok(sw.includes("CACHE = 'insync-v10-33'")&&sw.includes("'intelligence.js'")&&sw.includes("'prompt-registry.js'"),'Phase 2 Intelligence files are part of the offline shell');
 ok(app.includes("version:'6.0.0-p6.0'")&&settings.includes('Version 6.0.0-p6.0'),'runtime and Settings identify the Phase 2 build');
